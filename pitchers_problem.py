...
class PitchersState:
    ...
    def result(self, move):
        ...
        return_state = PitchersState([self.goal] + list(self.capacities + contents))
        return return_state
...
class PitchersPuzzleSearchProblem(search.SearchProblem):
    ...
    Each state is represented by an instance of PitchersState.
    """
    ...
    def getSuccessors(self, state):
        ...
        each successor is the result of applying action to state
...
def loadPitchersPuzzle(puzzleNumber):
    ...
    puzzleNumber can range from 0 to len(PITCHERS_PUZZLE_DATA)-1.
    """
